...
\documentclass[a4paper,11pt,leqno,openbib,11pt,openany,oneside]{memoir} %add 'draft' to turn draft option on (see below)
%
\linespread{1.2}
% Adding metadata:
\usepackage{datetime}
...
\DeclareAcronym{hte}{
  short=HTE,
  long=Heterogeneous Treatment Effect,
}
\DeclareAcronym{cate}{
  short=CATE,
  long=Conditional Average Treatment Effect,
}
\DeclareAcronym{SEK}{
  short=SEK,
  long=Swedish Krona,
...
\DeclareAcronym{GBP}{
  short=GBP,
  long=Green Bond Principles,
}
\DeclareAcronym{CBI}{
  short=CBI,
  long=Climate Bonds Initiative,
}
\DeclareAcronym{OLS}{
  short=OLS,
...
\DeclareAcronym{PSM}{
  short=PSM,
  long=Propensity Score Matching,
}
\DeclareAcronym{CEM}{
  short=CEM,
  long=Coarsened Exact Matching,
}
\DeclareAcronym{CIA}{
  short=CIA,
  long=Conditional Independence Assumption,
}
\DeclareAcronym{AIPW}{
  short=AIPW,
  long=Augmented Inverse Probability Weighting,
}
\DeclareAcronym{SUTVA}{
  short=SUTVA,
  long=Stable Unit Treatment Value Assumption,
}
\DeclareAcronym{i.i.d}{
  short=i.i.d,
  long=identically and independently distributed,
}
\DeclareAcronym{DGP}{
  short=DGP,
  long=Data Generating Process,
}
...
\usepackage[authoryear,square,semicolon,sort&compress]{natbib}

\definecolor{citecolour}{rgb}{0.0,0.5,0.0}
...
\import{chapters/appendices/}{app0F.tex}
%\clearemptydoublepage
